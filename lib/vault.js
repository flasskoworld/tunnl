...
export function vaultFor(moduleKey, model = null, context = {}) {
  ...
  return {
    ...
    fields: [
      ...
      { key: "decision", label: project ? "What decision does this work require?" : "What decision are you making?", prompt: "Write the choice and the tradeoff in one clear sentence.", type: "textarea" },
      { key: "work", label: project ? "What will you make or test next?" : "What will you make or test?", prompt: "Name the smallest artifact or real-world test you will complete.", type: "textarea" },
