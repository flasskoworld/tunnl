...
export function vaultFor(moduleKey, model = null) {
  ...
  return {
    ...
    fields: [
      ...
      { key: "decision", label: "What decision are you making?", prompt: "Write the choice and the tradeoff in one clear sentence.", type: "textarea" },
      { key: "work", label: "What will you make or test?", prompt: "Name the smallest artifact or real-world test you will complete.", type: "textarea" },
