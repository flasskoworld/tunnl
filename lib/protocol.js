...
export function buildProtocol(memo, profile, checkpoint = {}) {
  ...
  days.push({
    day: 1,
    type: "kickoff",
    title: "Create your one-line Sprint Brief",
    detail: `Write this sentence: "For the next 14 days, I am improving [constraint] by watching [observable signal]." Use your reading as the starting point: "${memo.verdict}" Put the finished sentence somewhere visible before you continue.`,
    minutes: 15,
    why: "A visible Sprint Brief turns the diagnosis into one decision you can use immediately.",
    doneWhen: "Your one-sentence Sprint Brief names the constraint and one observable sign of improvement, and it is saved somewhere you will see it tomorrow.",
    reflection: "What would make this the most useful constraint to improve over the next 14 days?",
