...
export function buildProtocol(memo, profile) {
  ...
  days.push({
    ...
    minutes: 25,
    why: "The Protocol is complete only when the work changes what you will do next.",
    doneWhen: "You have recorded the strongest result, the unresolved constraint, and the next 30-day commitment.",
